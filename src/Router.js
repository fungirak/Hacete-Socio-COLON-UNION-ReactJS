      ...
      <div className="navbar-nav bg-dark shadow">
        <ul className="nav d-flex justify-content-around">
          <li className="nav-item p-3">
            <Link to="/hacete-socio-colon" className="text-danger p-2 border border-2 rounded border-danger">COLON</Link>
          </li>
          <li className="nav-item p-3">
            <Link to="/"  className="text-light">¡HACETE SOCIO!</Link>
          </li>
          <li className="nav-item p-3">
            <Link to="/hacete-socio-union"  className="text-danger p-2 border border-2 rounded border-danger bg-white">UNION</Link>
          </li>
